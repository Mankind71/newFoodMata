<?php
  ...
  $kitchenName = $_GET['kitchen'];
  $name = $_SESSION[$kitchenName];

  require 'classes/GetKitchen.php';
  $newKitchen = new GetKitchen($kitchenName);
...
<p id="hiddenName", ><?php echo $kitchenName ?></p>
<h2 class='padding-top' id='some'><?php echo $name ?></h2>
